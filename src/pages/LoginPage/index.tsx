    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-100 px-6">
      ...
      >
        ...
        {erro && (
          ...
          >
            <svg
              className="flex-shrink-0 inline h-5 w-5 shrink-0 me-3 mt-[2px]"
              aria-hidden="true"
            ...
            <div>
              <span className="font-bold">Erro!</span> Algo correu mal. Por
              favor, verifica os dados introduzidos e tenta novamente.
            </div>
          </div>
        )}
